...
function Dashboard(){
    ...
    const viewProducts = async ()=>{
        try{
            const response = await axios.get("https://backend-e7yx.onrender.com/viewProducts")
    ...
    const deleteProduct = async (id) => {
        ...
        if (isConfirmed) {
            try {
                const response = await axios.delete(`https://backend-e7yx.onrender.com/deleteProduct/${id}`);
